...
/* harmony import */ var _components_calculate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/calculate */ "./src/js/components/calculate.js");
/* harmony import */ var _components_calculate__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_calculate__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_catalog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/catalog */ "./src/js/components/catalog.js");
/* harmony import */ var _components_catalog__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_catalog__WEBPACK_IMPORTED_MODULE_4__);
...
var scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_0___default())('a[href*="#"]'); // Подключение событий свайпа на мобильных
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  btnUp: document.querySelector('.arrow__up')
});
...
/* harmony import */ var _vendor_inputmask_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/inputmask.min */ "./src/js/vendor/inputmask.min.js");
/* harmony import */ var _vendor_inputmask_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_inputmask_min__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_just_validate_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/just-validate.min */ "./src/js/vendor/just-validate.min.js");
/* harmony import */ var _vendor_just_validate_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_just_validate_min__WEBPACK_IMPORTED_MODULE_2__);
...
document.querySelector('.calculate__block').addEventListener('click', function (event) {
  var currentTarget = event.target;

  if (currentTarget.classList.contains('plus')) {
    event.preventDefault();
    var count = currentTarget.parentElement.querySelector('input');
    var value = count.value;
    value = parseInt(value) + 1;
    count.value = value;
  } else if (currentTarget.classList.contains('minus')) {
    event.preventDefault();

    var _count = currentTarget.parentElement.querySelector('input');

    var _value = _count.value;
...
function plus(array) {
  array.value = parseInt(array.value) + 1;
}
...
quantityPlus.forEach(function (element) {
  element.addEventListener('click', function (event) {
    var amount = event.target.previousSibling.previousElementSibling;
    amount.value = parseInt(amount.value) + 1;
  });
});
quantityMinus.forEach(function (element) {
  element.addEventListener('click', function (event) {
    var amount = event.target.nextSibling.nextElementSibling;
...
var catalogList = document.querySelectorAll(".catalog__list");
var category__btn = document.querySelectorAll(".category__btn");
document.querySelector('.category').addEventListener('click', function (event) {
  // event.preventDefault();
  category__btn.forEach(function (el) {
    el.classList.remove('category__btn--active');
  });

  if (!event.target.classList.contains('category__btn--active')) {
    event.target.classList.add('category__btn--active');
  } else {
    event.target.classList.remove('category__btn--active');
  }

  var filterClass = event.target.dataset['f'];
  catalogList.forEach(function (elem) {
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            ...
            popup_wrapper.classList.add('visible');
          }
        }
      };
...
!function webpackUniversalModuleDefinition(root, factory) {
  ...
  return modules = [function (module) {
  ...
  }, function (module, exports, __nested_webpack_require_1365__) {
    "use strict";
    ...
    var $ = __nested_webpack_require_1365__(2),
        window = __nested_webpack_require_1365__(3),
        document = window.document,
        generateMaskSet = __nested_webpack_require_1365__(4).generateMaskSet,
        analyseMask = __nested_webpack_require_1365__(4).analyseMask,
        maskScope = __nested_webpack_require_1365__(7);
  ...
  }, function (module, exports, __nested_webpack_require_11900__) {
    "use strict";
    ...
    var window = __nested_webpack_require_11900__(3),
        document = window.document;
  ...
  }, function (module, exports, __nested_webpack_require_21082__) {
    "use strict";
    ...
    }.call(exports, __nested_webpack_require_21082__, exports, module), void 0 === __WEBPACK_AMD_DEFINE_RESULT__ || (module.exports = __WEBPACK_AMD_DEFINE_RESULT__);
  }, function (module, exports, __nested_webpack_require_21877__) {
    "use strict";

    var $ = __nested_webpack_require_21877__(2);
  ...
  }, function (module, exports, __nested_webpack_require_36182__) {
    "use strict";

    __nested_webpack_require_36182__(6), __nested_webpack_require_36182__(8), __nested_webpack_require_36182__(9), __nested_webpack_require_36182__(10), module.exports = __nested_webpack_require_36182__(1);
  }, function (module, exports, __nested_webpack_require_36398__) {
    "use strict";

    var Inputmask = __nested_webpack_require_36398__(1);
  ...
  }, function (module, exports, __nested_webpack_require_39295__) {
    "use strict";
    ...
    var $ = __nested_webpack_require_39295__(2),
        window = __nested_webpack_require_39295__(3),
        document = window.document,
        ...
        keyCode = __nested_webpack_require_39295__(0);
  ...
  }, function (module, exports, __nested_webpack_require_126156__) {
    "use strict";
    ...
    var Inputmask = __nested_webpack_require_126156__(1),
        $ = Inputmask.dependencyLib,
        keyCode = __nested_webpack_require_126156__(0),
        formatCode = {
  ...
  }, function (module, exports, __nested_webpack_require_140294__) {
    "use strict";

    var Inputmask = __nested_webpack_require_140294__(1),
        $ = Inputmask.dependencyLib,
        keyCode = __nested_webpack_require_140294__(0);
  ...
  }, function (module, exports, __nested_webpack_require_161878__) {
    "use strict";

    var _inputmask = _interopRequireDefault(__nested_webpack_require_161878__(1));
  ...
  }], installedModules = {}, __nested_webpack_require_168499__.m = modules, __nested_webpack_require_168499__.c = installedModules, __nested_webpack_require_168499__.d = function (exports, name, getter) {
    __nested_webpack_require_168499__.o(exports, name) || Object.defineProperty(exports, name, {
      enumerable: !0,
      get: getter
    });
  }, __nested_webpack_require_168499__.r = function (exports) {
    "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(exports, Symbol.toStringTag, {
      value: "Module"
    }), Object.defineProperty(exports, "__esModule", {
      value: !0
    });
  }, __nested_webpack_require_168499__.t = function (value, mode) {
    if (1 & mode && (value = __nested_webpack_require_168499__(value)), 8 & mode) return value;
    if (4 & mode && "object" == _typeof2(value) && value && value.__esModule) return value;
    var ns = Object.create(null);
    if (__nested_webpack_require_168499__.r(ns), Object.defineProperty(ns, "default", {
      enumerable: !0,
      value: value
    }), 2 & mode && "string" != typeof value) for (var key in value) {
      __nested_webpack_require_168499__.d(ns, key, function (key) {
        return value[key];
      }.bind(null, key));
    }
    return ns;
  }, __nested_webpack_require_168499__.n = function (module) {
    var getter = module && module.__esModule ? function getDefault() {
      return module.default;
    } : function getModuleExports() {
      return module;
    };
    return __nested_webpack_require_168499__.d(getter, "a", getter), getter;
  }, __nested_webpack_require_168499__.o = function (object, property) {
    return Object.prototype.hasOwnProperty.call(object, property);
  }, __nested_webpack_require_168499__.p = "", __nested_webpack_require_168499__(__nested_webpack_require_168499__.s = 5);

  function __nested_webpack_require_168499__(moduleId) {
    ...
    return modules[moduleId].call(module.exports, module, module.exports, __nested_webpack_require_168499__), module.l = !0, module.exports;
  }
...
/* harmony import */ var _functions_disable_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/disable-scroll */ "./src/js/functions/disable-scroll.js");
/* harmony import */ var _functions_enable_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/enable-scroll */ "./src/js/functions/enable-scroll.js");
...
document.querySelector('.calculate__submit').addEventListener('click', function (event) {
  event.preventDefault();
  document.querySelector('.overlay').classList.add('overlay--visible');
  document.querySelector('.popup__wrapper').classList.add('popup__wrapper--visible');
  (0,_functions_disable_scroll__WEBPACK_IMPORTED_MODULE_4__.disableScroll)();
});
document.querySelector('.close_button').addEventListener('click', function (event) {
  document.querySelector('.overlay').classList.remove('overlay--visible');
  document.querySelector('.popup__wrapper').classList.remove('popup__wrapper--visible');
  (0,_functions_enable_scroll__WEBPACK_IMPORTED_MODULE_5__.enableScroll)();
});
window.addEventListener('scroll', function () {
  if (pageYOffset > 2000) {
    _vars__WEBPACK_IMPORTED_MODULE_1__["default"].btnUp.classList.add('visible');
  } else {
    _vars__WEBPACK_IMPORTED_MODULE_1__["default"].btnUp.classList.remove('visible');
  }
});
})();
